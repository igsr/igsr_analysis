package PyHive::PipeConfig::INTEGRATION::VCFIntegrationGATKUGINDEL;
...
sub default_options {
    ...
    return {
        ...
        'pipeline_name' => 'run_vcfintegration_gatkugindel',       # name used by the beekeeper to prefix job names on the farm
