package PyHive::PipeConfig::INTEGRATION::VCFIntegrationGATKUGSNP.pm;
...
sub default_options {
    ...
    return {
        ...
        'pipeline_name' => 'run_vcfintegration_gatkugsnp',       # name used by the beekeeper to prefix job names on the farm
