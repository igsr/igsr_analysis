package PyHive::PipeConfig::INTEGRATION::VCFIntegrationGATKHCINDEL;
...
sub default_options {
    ...
    return {
        ...
        'pipeline_name' => 'run_vcfintegration_hc_indels',       # name used by the beekeeper to prefix job names on the farm
...
#		'chunk_ixs' => '[223,224,225,226,227,228,229,230,231,232,233,234,235,236,237,238,239,240,241,242,243,244,245,246,247,248,249,250,251,252,253,254,255,256,257,258,259,260]',
	...
	{   -logic_name => 'index_merge_transpose_bams',
	    ...
	    -flow_into => {
		1 => {'run_gatkhc_indels_lowmem' => INPUT_PLUS() }
	    },
            -rc_name => '5Gb'
        },

	{   -logic_name => 'run_gatkhc_indels_lowmem',
            -module     => 'PyHive.VariantCalling.GATK_HC',
            -language   => 'python3',
            -parameters => {
		...
		'bamlist' => '#merged_bam#',
		'bgzip_folder' => $self->o('bgzip_folder'),
		'work_dir' => $self->o('work_dir')."/gatk_hc",
	...
	{   -logic_name => 'run_gatkhc_indels_himem1',
            -module     => 'PyHive.VariantCalling.GATK_HC',
            -language   => 'python3',
            -parameters => {
                'genotyping_mode' => 'GENOTYPE_GIVEN_ALLELES',
		...
		'standard_min_confidence_threshold_for_calling' => 0,
            ...
            -rc_name => '20Gb4cpus',
	    -flow_into => {
	       -1 => [ 'run_gatkhc_indels_himem2' ],
                1 => [ '?accu_name=allchunks_files&accu_address=[]&accu_input_variable=out_vcf','?accu_name=allixs&accu_address=[]&accu_input_variable=ix']
	   },
        },
	
	{   -logic_name => 'run_gatkhc_indels_himem2',
            -module     => 'PyHive.VariantCalling.GATK_HC',
            -language   => 'python3',
            -parameters => {
                'genotyping_mode' => 'GENOTYPE_GIVEN_ALLELES',
