=head1 NAME
 ...
 PyHive::PipeConfig::FILTER::VCFilterSamtoolsWES

=head1 SYNOPSIS

This pipeline is used to filter a WES (Whole Exome Sequencing) VCF generated using BCFTools.
...
-bed_offtarget: Path to .BED file with the coordinates of the Exome targets. Variants not falling in an Exome target
 will be filtered
