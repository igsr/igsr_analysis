...
class BcftoolsVcfNorm(eHive.BaseRunnable):
    ...
    def run(self):
        ...
        vcf_file=vcfNorm.run_bcftoolsnorm(outprefix=outprefix, reference=self.param_required('reference'), multiallelics=self.param('multiallelics'), type=self.param('type'))
