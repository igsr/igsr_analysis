GATK variant filtering pipeline
===============================
...
3. Initialise the pipeline
  ...
  The rest of the options are documented in the `PyHive::PipeConfig::VCFilterGATK.pm <https://github.com/igsr/igsr_analysis/blob/newphasing/PyHive/PipeConfig/FILTER/VCFilterGATK.pm>`_
