...
3. Initialise the pipeline
  ...
  The rest of the options are documented in the `PyHive::PipeConfig::QC::RunBamQCsonWGS <https://github.com/igsr/igsr_analysis/blob/master/PyHive/PipeConfig/QC/RunBamQCsonWGS.pm>`_
