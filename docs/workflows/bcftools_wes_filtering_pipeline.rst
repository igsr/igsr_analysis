BCFtools WES variant filtering pipeline
=======================================
...
3. Initialise the pipeline
  ...
  The rest of the options are documented in the `PyHive::PipeConfig::FILTER::VCFilterSamtoolsWES <https://github.com/igsr/igsr_analysis/blob/newphasing/PyHive/PipeConfig/FILTER/VCFilterSamtoolsWES.pm>`_
