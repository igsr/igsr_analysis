...
=head1 NAME
    ...
    Hive::PipeConfig::RunPicardOnWGS_conf

=head1 SYNOPSIS

    init_pipeline.pl Hive::PipeConfig::RunPicardOnWGS_conf -inputfile file_list -work_dir dir_name -db reseqtrack_db_name -pwd db_pwd


=cut


package Hive::PipeConfig::RunPicardOnWGS_conf;
...
sub default_options {
    ...
    return {
        ...
        'pipeline_name' => 'run_picard_on_wgsbam',                   # name used by the beekeeper to prefix job names on the farm
